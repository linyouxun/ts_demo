...
import './NewStatisticsFilter.less';
...
class NewStatisticsFilter extends React.Component<IProps & FormComponentProps, any> {
            ...
            <Col span={8}>
              <FormItem label="ID" {...formProps} help="">
                {getFieldDecorator('id')(
                  <Input style={{ width: '100%' }} type="text" placeholder="页面ID查询"/>
                )}
              </FormItem>
            </Col>
            {/* <Col span={8}>
...
export default Form.create()(NewStatisticsFilter);
