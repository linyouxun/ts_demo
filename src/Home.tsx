...
class Home extends React.Component<any, any> {
  public componentDidMount() {
    ...
    Modal.warn({
      ...
      content: <img style={{width: '100%'}} src="http://47.106.174.88/accout.png" alt=""/>,
      onCancel: () => {
  ...
  public render() {
    return (<div className="home">
      ...
      <img src="http://47.106.174.88/accout.png" alt=""/>
      <br/>
      <br/>
      <h4>如有遗漏，纯属巧合</h4>
      <pre>
        本次更新更新：
          1.基本信息添加<span>上报ID</span>;
          2.添加新控件跳转了<span>链接按钮</span>
      </pre>
      <pre>
        下版预计更新：
          1.<span>单点登录</span>;限制账号同时多点登录，多用户使用同一账号;
          2.新功能开发
      </pre>
    </div>)
  }
